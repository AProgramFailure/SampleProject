...
import groupNumber.uno.client.model.game.contract.SevenZero;
...
public class SevenZeroUnoMode extends PlayingMode implements SevenZero {

    public SevenZeroUnoMode() {
